...
date_string = datetime.now(pytz.timezone('America/Chicago')).strftime("%Y-%m-%d_%H:%M:%S")
...
class TestS3AWK(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with engine.connect() as connection:
            ...
            result_date_clean = [x for x in result_date][0][0]
    ...
    def test_staging_file_count(self):
        ...
        """)
        print(f"The AWK Staging Bucket has {self.s3_staging_len} files.. ", end='')
    ...
    def test_current_file_count(self):
        ...
        """)
        print(f"The AWK Current Bucket has {self.s3_current_len} files.. ", end='')
    ...
    def test_staging_files_lastupdate(self):
        ...
        """)
        print(f"The Number of AWK Staging Files that haven't been updated is {self.s3_staging_lastupdate}.. ", end='')
    ...
    def test_current_files_lastupdate(self):
        ...
        """)
        print(f"The Number of AWK Current Files that haven't been updated is {self.s3_current_lastupdate}.. ", end='')
    ...
    def test_staging_filesizes(self):
        ...
        """)
        print(f"The Number of AWK Staging Files that aren't the proper size is {self.s3_staging_filesizes}.. ", end='')
    ...
    def test_current_filesizes(self):
        ...
        """)
        print(f"The Number of AWK Current Files that aren't the proper size is {self.s3_current_filesizes}.. ", end='')
    ...
    def test_db_recordcount(self):
        ...
        """)
        print(f"The Number of Records in the Postgresql Database is {self.db_record_count}.. ", end='')
    ...
    def test_db_lastupdate(self):
        ...
        """)
        print(f"The Postgresql Database was last updated {self.db_hour_diff} hours ago.. ", end='')
...
def lambda_handler(event, context):
    ...
    s3_key = f"logs/{date_string}_testing.log"
